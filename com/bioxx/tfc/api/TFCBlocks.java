...
/* 160 */   public static Block[] doors = new Block[Global.WOOD_ALL.length];
/*     */   
...
/* 240 */     return (block == woodSupportV || block == woodSupportV2);
/*     */   }
/*     */ 
/*     */   
/*     */   public static boolean isBlockHSupport(Block block) {
/* 245 */     return (block == woodSupportH || block == woodSupportH2);
/*     */   }
/*     */ 
/*     */   
/*     */   public static boolean isBlockAFence(Block block) {
/* 250 */     return (block == GrowthCraftCore.blocks.fenceRope.getBlock() || block == GrowthCraftCore.blocks.fenceRope2.getBlock() || block == fence || block == fence2 || BlockFence.func_149825_a(block));
/*     */   }
/*     */ 
/*     */   
/*     */   public static boolean canFenceConnectTo(Block block) {
/* 255 */     return (isBlockAFence(block) || block == fenceGate || block == fenceGate2);
/*     */   }
/*     */ 
/*     */   
/*     */   public static boolean isArmourStand(Block block) {
/* 260 */     return (block == armorStand || block == armorStand2);
/*     */   }
/*     */ }


/* Location:              D:\workdir\java\tfc\Source_other\[1.7.10]TerraFirmaCraft_client.jar!\com\bioxx\tfc\api\TFCBlocks.class
