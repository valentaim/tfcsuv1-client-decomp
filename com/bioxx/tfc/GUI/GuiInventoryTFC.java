...
/* 260 */     String itype = is.func_77973_b().func_77658_a().toLowerCase();
/* 261 */     return (itype.contains("salad") || itype.contains("soup") || itype.contains("sandwich"));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 268 */     boolean cooking = false;
/* 269 */     if (this.activeSlot != null && this.activeSlot.field_75222_d == 0 && this.activeSlot.func_75216_d() && this.activeSlot
/* 270 */       .func_75211_c().func_77973_b() instanceof com.bioxx.tfc.api.Interfaces.IFood) {
/* 271 */       return false;
/*     */     }
/* 273 */     if (this.activeSlot != null && this.activeSlot.func_75216_d() && 
/* 274 */       isCooking(this.activeSlot.func_75211_c())) cooking = true;
/*     */     
/* 276 */     if (!cooking && keycode == 31 && this.activeSlot != null && this.activeSlot.func_82869_a(this.player) && this.activeSlot.func_75216_d() && this.activeSlot
/* 277 */       .func_75211_c() != null && this.activeSlot.func_75211_c().func_77973_b() instanceof com.bioxx.tfc.api.Interfaces.IFood && TFC_Time.getTotalTicks() > this.spamTimer + 5L) {
/*     */       
/* 279 */       this.spamTimer = TFC_Time.getTotalTicks();
/* 280 */       Item iType = this.activeSlot.func_75211_c().func_77973_b();
/* 281 */       ItemStack activeIS = this.activeSlot.func_75211_c();
/* 282 */       for (int i = 9; i < 45 && getEmptyCraftSlot() != -1; i++) {
/*     */         
/* 284 */         ItemStack is = this.field_147002_h.func_75139_a(i).func_75211_c();
/* 285 */         if (is != null && is.func_77973_b() == iType && Food.areEqual(activeIS, is) && Food.getWeight(is) < 160.0F) {
/* 286 */           func_146984_a(this.field_147002_h.func_75139_a(i), i, getEmptyCraftSlot(), 7);
/*     */         }
/*     */       } 
/* 289 */       if (this.field_147002_h.func_75139_a(0).func_75211_c() != null)
/*     */       {
/* 291 */         func_146984_a(this.field_147002_h.func_75139_a(0), 0, 0, 1);
/*     */       }
/* 293 */       return true;
/*     */     } 
/* 295 */     if (!cooking && keycode == 32 && TFC_Time.getTotalTicks() > this.spamTimer + 5L) {
/*     */       
/* 297 */       this.spamTimer = TFC_Time.getTotalTicks();
/* 298 */       int knifeSlot = -1;
/* 299 */       if (!getCraftingHasKnife())
/*     */       {
/* 301 */         for (int j = 9; j < 45 && getEmptyCraftSlot() != -1; j++) {
/*     */           
/* 303 */           ItemStack is = this.field_147002_h.func_75139_a(j).func_75211_c();
/* 304 */           if (is != null && is.func_77973_b() instanceof com.bioxx.tfc.api.Tools.IKnife) {
/*     */             
/* 306 */             knifeSlot = j;
/*     */             break;
/*     */           } 
/*     */         } 
/*     */       }
/* 311 */       for (int i = 9; i < 45 && getEmptyCraftSlot() != -1 && knifeSlot != -1 && this.field_147002_h.func_75139_a(knifeSlot).func_75211_c() != null; i++) {
/*     */         
/* 313 */         ItemStack is = this.field_147002_h.func_75139_a(i).func_75211_c();
/* 314 */         int knifeDamage = this.field_147002_h.func_75139_a(knifeSlot).func_75211_c().func_77960_j();
/* 315 */         if (knifeDamage >= this.field_147002_h.func_75139_a(knifeSlot).func_75211_c().func_77958_k()) {
/*     */           break;
/*     */         }
/* 318 */         if (is != null && !isCooking(is) && 
/* 319 */           is != null && !(is.func_77973_b() instanceof com.bioxx.tfc.Food.ItemMeal) && is.func_77973_b() instanceof com.bioxx.tfc.api.Interfaces.IFood && Food.getDecay(is) > 0.0F && 
/* 320 */           Food.getDecayTimer(is) >= TFC_Time.getTotalHours()) {
/*     */           
/* 322 */           func_146984_a(this.field_147002_h.func_75139_a(i), i, getEmptyCraftSlot(), 7);
/* 323 */           func_146984_a(this.field_147002_h.func_75139_a(0), 0, 0, 1);
/*     */         } 
/*     */       } 
/* 326 */       return true;
/*     */     } 
/* 328 */     return super.func_146983_a(keycode);
/*     */   }
/*     */ 
/*     */   
/*     */   private int getEmptyCraftSlot() {
/* 333 */     if (this.field_147002_h.func_75139_a(4).func_75211_c() == null)
/* 334 */       return 4; 
/* 335 */     if (this.field_147002_h.func_75139_a(1).func_75211_c() == null)
/* 336 */       return 1; 
/* 337 */     if (this.field_147002_h.func_75139_a(2).func_75211_c() == null)
/* 338 */       return 2; 
/* 339 */     if (this.field_147002_h.func_75139_a(3).func_75211_c() == null)
/* 340 */       return 3; 
/* 341 */     if (this.player.getEntityData().func_74764_b("craftingTable")) {
/*     */       
/* 343 */       if (this.field_147002_h.func_75139_a(45).func_75211_c() == null)
/* 344 */         return 45; 
/* 345 */       if (this.field_147002_h.func_75139_a(46).func_75211_c() == null)
/* 346 */         return 46; 
/* 347 */       if (this.field_147002_h.func_75139_a(47).func_75211_c() == null)
/* 348 */         return 47; 
/* 349 */       if (this.field_147002_h.func_75139_a(48).func_75211_c() == null)
/* 350 */         return 48; 
/* 351 */       if (this.field_147002_h.func_75139_a(49).func_75211_c() == null) {
/* 352 */         return 49;
/*     */       }
/*     */     } 
/* 355 */     return -1;
...
/* 360 */     if (this.field_147002_h.func_75139_a(4).func_75211_c() != null && this.field_147002_h.func_75139_a(4).func_75211_c().func_77973_b() instanceof com.bioxx.tfc.api.Tools.IKnife)
/* 361 */       return true; 
/* 362 */     if (this.field_147002_h.func_75139_a(1).func_75211_c() != null && this.field_147002_h.func_75139_a(1).func_75211_c().func_77973_b() instanceof com.bioxx.tfc.api.Tools.IKnife)
/* 363 */       return true; 
/* 364 */     if (this.field_147002_h.func_75139_a(2).func_75211_c() != null && this.field_147002_h.func_75139_a(2).func_75211_c().func_77973_b() instanceof com.bioxx.tfc.api.Tools.IKnife)
/* 365 */       return true; 
/* 366 */     if (this.field_147002_h.func_75139_a(3).func_75211_c() != null && this.field_147002_h.func_75139_a(3).func_75211_c().func_77973_b() instanceof com.bioxx.tfc.api.Tools.IKnife)
/* 367 */       return true; 
/* 368 */     if (this.player.getEntityData().func_74764_b("craftingTable")) {
/*     */       
/* 370 */       if (this.field_147002_h.func_75139_a(45).func_75211_c() != null && this.field_147002_h.func_75139_a(45).func_75211_c().func_77973_b() instanceof com.bioxx.tfc.api.Tools.IKnife)
/* 371 */         return true; 
/* 372 */       if (this.field_147002_h.func_75139_a(46).func_75211_c() != null && this.field_147002_h.func_75139_a(46).func_75211_c().func_77973_b() instanceof com.bioxx.tfc.api.Tools.IKnife)
/* 373 */         return true; 
/* 374 */       if (this.field_147002_h.func_75139_a(47).func_75211_c() != null && this.field_147002_h.func_75139_a(47).func_75211_c().func_77973_b() instanceof com.bioxx.tfc.api.Tools.IKnife)
/* 375 */         return true; 
/* 376 */       if (this.field_147002_h.func_75139_a(48).func_75211_c() != null && this.field_147002_h.func_75139_a(48).func_75211_c().func_77973_b() instanceof com.bioxx.tfc.api.Tools.IKnife)
/* 377 */         return true; 
/* 378 */       if (this.field_147002_h.func_75139_a(49).func_75211_c() != null && this.field_147002_h.func_75139_a(49).func_75211_c().func_77973_b() instanceof com.bioxx.tfc.api.Tools.IKnife) {
/* 379 */         return true;
/*     */       }
/*     */     } 
/* 382 */     return false;
...
/* Location:              D:\workdir\java\tfc\Source_other\[1.7.10]TerraFirmaCraft_client.jar!\com\bioxx\tfc\GUI\GuiInventoryTFC.class
