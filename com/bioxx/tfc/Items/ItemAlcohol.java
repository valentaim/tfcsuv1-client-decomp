...
/* 114 */         player.func_70690_d(new PotionEffect(8, time, 4));
/*     */       }
/* 116 */       if (rand.nextInt(100) == 0) {
/* 117 */         player.func_70690_d(new PotionEffect(5, time, 4));
/*     */       }
/* 119 */       if (rand.nextInt(100) == 0) {
/* 120 */         player.func_70690_d(new PotionEffect(8, time, 4));
/*     */       }
/* 122 */       if (rand.nextInt(200) == 0) {
/* 123 */         player.func_70690_d(new PotionEffect(10, time, 4));
/*     */       }
...
/* Location:              D:\workdir\java\tfc\Source_other\[1.7.10]TerraFirmaCraft_client.jar!\com\bioxx\tfc\Items\ItemAlcohol.class
