...
/*  23 */     this.horseInv = invHorse;
/*  24 */     this.horse = entityHorse;
/*  25 */     invHorse.func_70295_k_();
/*  26 */     func_75146_a((Slot)new ContainerHorseInventorySlotSaddle(this, invHorse, 0, 8, 18));
/*  27 */     func_75146_a((Slot)new ContainerHorseInventorySlotArmor(this, this.horseInv, 1, 8, 36, (EntityHorse)this.horse));
/*     */     
/*  29 */     if (entityHorse.func_110261_ca())
/*     */     {
/*     */       
...
/* Location:              D:\workdir\java\tfc\Source_other\[1.7.10]TerraFirmaCraft_client.jar!\com\bioxx\tfc\Containers\ContainerHorseInventoryTFC.class
