...
/* 43 */           int outID = thisID;
/*    */           
/* 45 */           if (id0 < GenEVTLayer.HIGH && func_75902_a(count++) == 0) {
/* 46 */             outID = id0 + 1;
/*    */           }
/* 48 */           if (id1 < GenEVTLayer.HIGH && func_75902_a(count++) == 0) {
/* 49 */             outID = id1 + 1;
/*    */           }
/* 51 */           if (id2 < GenEVTLayer.HIGH && func_75902_a(count++) == 0) {
/* 52 */             outID = id2 + 1;
/*    */           }
/* 54 */           if (id3 < GenEVTLayer.HIGH && func_75902_a(count++) == 0) {
/* 55 */             outID = id3 + 1;
/*    */           }
/* 57 */           if (func_75902_a(3) == 0 && outID <= GenEVTLayer.HIGH) {
...
/* 65 */           int outID = thisID;
/*    */           
/* 67 */           if (id0 > GenEVTLayer.LOW && func_75902_a(count++) == 0) {
/* 68 */             outID = id0 - 1;
/*    */           }
/* 70 */           if (id1 > GenEVTLayer.LOW && func_75902_a(count++) == 0) {
/* 71 */             outID = id1 - 1;
/*    */           }
/* 73 */           if (id2 > GenEVTLayer.LOW && func_75902_a(count++) == 0) {
/* 74 */             outID = id2 - 1;
/*    */           }
/* 76 */           if (id3 > GenEVTLayer.LOW && func_75902_a(count++) == 0) {
/* 77 */             outID = id3 - 1;
/*    */           }
/* 79 */           if (func_75902_a(3) == 0 && outID >= GenEVTLayer.LOW) {
...
/* Location:              D:\workdir\java\tfc\Source_other\[1.7.10]TerraFirmaCraft_client.jar!\com\bioxx\tfc\WorldGen\GenLayers\DataLayers\EVT\GenLayerAddEVT.class
